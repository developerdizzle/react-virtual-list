    ...
    return _temp = _class = function (_PureComponent) {
      ...
      _createClass(vlist, [{
        ...
        value: function setStateIfNeeded(list, container, items, itemHeight, itemBuffer) {
          ...
          var stateFactory = this.props.getVisibleItemBounds || _getVisibleItemBounds2.default;
          var state = stateFactory(list, container, items, itemHeight, itemBuffer, _getVisibleItemBounds2.default);
      ...
      getVisibleItemBounds: _propTypes2.default.func,
